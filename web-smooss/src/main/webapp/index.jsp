		...
		<div class="collapse navbar-collapse justify-content-end"
			...
			<div class="navbar-nav mr-5 link_style">
				<a class="nav-item nav-link" data-toggle="modal"
					data-target="#modalConnexion">Connexion</a> <a
					class="nav-item nav-link" data-toggle="modal"
					data-target="#modalInscription">Inscription</a>
			</div>
		</div>
	</nav>
				...
				<form method="POST" action="RegisterServlet">
						...
						<div class="form-group">
							<div class="input-group">
								...
								<input type="text" class="form-control" name="nickName"
									placeholder="Pseudo" class="input_modal">
							</div>
						</div>
						<div class="form-group">
							<div class="input-group">
					...
					<div class="modal-footer justify-content-center">
						<button type="submit" class="btn button_submit_modal"
							id="button_submit_inscription_modal">Devenir un Smoosser
							!</button>
					</div>
				</form>
			</div>
		...
		<div id="carouselExampleIndicators" class="carousel slide"
			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<img class="d-block w-100 h-100" src="img/second.jpg"
						alt="First slide">
				</div>
	...
	<footer id="footer_bottom_index">
		<div class="container-fluid">
			<div class="row justify-content-around">
				...
				<div class="footer_bottom_index_div">
					<h6>Règles</h6>
					<a href="#">Conditions</a> <a href="#">Politique de
